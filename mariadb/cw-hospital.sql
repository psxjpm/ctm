...
--
-- Host: mariadb
-- Generation Time: Dec 19, 2025 at 09:24 PM
...
INSERT INTO `adminlogin` (`id`, `username`, `password`, `staffno`) VALUES
(1, 'danny', 'tudor68', 'QM897'),
(2, 'Lala', 'admin', 'QM367'),
(3, 'kai', 'ret56', 'QM323'),
(4, 'helen', 'xixi78', 'QAD056'),
(5, 'zayn', 'poli62', 'QAD548'),
(6, 'Melissa', 'domoni89', 'QAD225'),
(7, 'hussein', 'philly67', 'QAD740'),
(8, 'sharonna', 'fretana78', 'QAD179'),
(9, 'Ruth', 'dress76', 'QAD930');
...
CREATE TABLE `doctor` (
  ...
  `specialisation` int(100) DEFAULT NULL,
...
INSERT INTO `doctor` (`staffno`, `firstname`, `lastname`, `specialisation`, `qualification`, `pay`, `gender`, `consultantstatus`, `address`, `password_doctor`) VALUES
('CH007', 'Steven', 'Fan', 0, NULL, 67000, 0, 1, '45 The Barnum Nottingham NG2 6TY', 'tudor68'),
('GT067', 'Julie', 'Ford', 0, 'CCT', 66000, 1, 1, NULL, 'merry67'),
('QM003', 'Joel ', 'Graham', 3, NULL, 44000, 0, 0, '1 Chatsworth Avenue, Carlton, Nottingham, NG4', 'marino90'),
('QM004', 'Jason', 'Atkin', 1, 'CCT', 60000, 0, 1, '102 Leeming Lane South, Mansfield Woodhouse, Mansfield', 'forest35'),
('QM009', 'Grazziela', 'Luis', 3, 'CCT', 62000, 1, 1, '16 Lenton Boulevard, Lenton, Nottingham, NG7 2ES', 'rabioni89'),
('QM122', 'David', 'Ulrik', 2, NULL, 46000, 0, 0, '3 Rolleston Drive, Nottingham', 'rateau78'),
('QM267', 'Andrew', 'Xin', 4, 'CCT', 58000, 0, 1, '44 Dunlop Avenue, Lenton, Nottingham NG1 5AW', 'meliyo34'),
('QM300', 'Joy', 'Liz', 0, 'CCT', 52000, 1, 0, '55 Wishford Avenue, Lenton, Nottingham', 'warren56'),
('QT001', 'Martin', 'Peter', 4, NULL, 48000, 0, 0, '47 Derby Road, Nottingham, NG1 5AW', 'shell46');

-- --------------------------------------------------------

--
-- Table structure for table `parkingpermit`
--
...
CREATE TABLE `parkingpermit` (
  ...
  `reason` text DEFAULT NULL COMMENT 'Fully booked'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `parkingpermit`
--

INSERT INTO `parkingpermit` (`parkingid`, `car_details`, `parking_type`, `price`, `staffno`, `id`, `status`, `reason`) VALUES
(10, 'ssaw34', 'monthly', 50, 'QM897', NULL, 'rejected', 'fully booked'),
(11, 'hj', 'yearly', 600, 'QM897', NULL, 'approved', NULL),
(12, 'hsg', 'monthly', 50, 'QM897', NULL, 'approved', NULL),
(13, 'ggt', 'yearly', 600, 'QM897', NULL, 'approved', NULL),
(14, 'ksajkahj', 'monthly', 50, 'QM897', NULL, 'rejected', 'fully booked'),
(15, 'm17hh', 'yearly', 600, 'CH007', NULL, 'pending', NULL);
...
INSERT INTO `patient` (`NHSno`, `password`, `firstname`, `lastname`, `phone`, `address`, `age`, `gender`, `emergencyphone`) VALUES
...
--
-- Indexes for table `parkingpermit`
--
...
--
-- AUTO_INCREMENT for table `parkingpermit`
--
ALTER TABLE `parkingpermit`
...
--
ALTER TABLE `test`
  MODIFY `testid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `patientexamination`
  ADD CONSTRAINT `fk_patient_link` FOREIGN KEY (`patientid`) REFERENCES `patient` (`NHSno`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `patient_test`
--
ALTER TABLE `patient_test`
  ADD CONSTRAINT `fk_test_link` FOREIGN KEY (`testid`) REFERENCES `test` (`testid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `wardpatientaddmission`
--
ALTER TABLE `wardpatientaddmission`
  ADD CONSTRAINT `fk_ward_link` FOREIGN KEY (`wardid`) REFERENCES `ward` (`wardid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
